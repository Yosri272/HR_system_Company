...
@section('content2')
         ...
         <div class="content-header">
          ...
          <section class="content">
            <div class="modal fade" id="categorytModal" tabindex="-1" role="dialog"
              aria-labelledby="categorytModalLabel" style="display: none;" aria-hidden="true">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="categorytModalLabel">اضافة</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true">×</span>
                    </button>
                  </div>
                  <form action="{{ url('categoriesSort')}}" method="GET" novalidate="">
                    <div class="modal-body">
                      <div class="form-group">
                        <label for="title">الاسم</label>
                        <input type="text" name="category_Name" class="form-control" placeholder=" إسم الفئة  ">
                      </div>
                    </div>
                ...
                <div class="card text-right">
                  <div class="card-header">
                    ...
                    <div class="card-tools">
                      <button class="btn btn-primary departments" data-toggle="modal" data-target="#categorytModal"><i
                      ...
                      <table id="datatable" class="datatable table table-bordered table-striped dataTable no-footer"
                        ...
                        <thead>
                          <tr role="row">
                            ...
                            <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 455px;">إسم الفئة</th>
                        ...
                        <tbody>
                          ...
                          <tr role="row" class="odd">
                            ...
                            <td>
                              ...
                              <a class="btn btn-info btn-xs" href="{{ url('view-categories') }}/{{  $data->category_id  }}"><i class="fa fa-eye"></i> عرض</a>
                              <button class="btn btn-warning btn-xs departments update" data-action="#"
                                data-title="خدمة العملاء" data-toggle="modal" data-target="#categorytModal"><i
                                  class="fa fa-edit"></i> تعديل</button>
                                  <button  class="btn btn-danger btn-xs delete" >
                                    <i class="fa fa-trash"></i><a href="{{  url('dalcategories')  }}/{{  $data->category_id  }}">حذف</a></button>
