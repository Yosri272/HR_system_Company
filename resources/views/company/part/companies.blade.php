                    ...
                    <div class="modal fade" id="modal1" tabindex="-1" role="dialog" aria-labelledby="modal1" aria-hidden="true">
                      <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                          ...
                          <form  method="post" action="{{ route('files.comp') }}" enctype="multipart/form-data">
						   @csrf
                            <div class="modal-body row">
                              <div class="form-group col-lg-6">
                                <label>اسم الشركة عربي</label>
                                <input name="comp_nameAR" class="form-control" type="text"/>
                              </div>
                              <div class="form-group col-lg-6">
                                <label>اسم الشركة انجليزي</label>
                                <input name="comp_NameEN" class="form-control" type="text"/>
                              </div>
                              <div class="form-group col-lg-6">
                                <label>نوع النشاط</label>
                                <input name="type_activity" class="form-control" type="text"/>
                              </div>
                              <div class="form-group col-lg-6">
                                <label>التلفون</label>
                                <input name="comp_TEL" class="form-control" type="number"/>
                              </div>
                              <div class="form-group col-lg-6">
                                <label>فاكس</label>
                                <input name="comp_FAX" class="form-control" type="text"/>
                              </div>
                              <div class="form-group col-lg-6">
                                <label>البريد</label>
                                <input name="comp_BOX" class="form-control" type="text"/>
                              </div>
                              <div class="form-group col-12">
                                <label>العنوان</label>
                                <input name="comp_ADDRESS" class="form-control" type="text"/>
                              </div>
                              <div class="form-group col-12">
                      ...
                      <table class="table table-bordered table-striped text-center">
						...
						@foreach($sys_company as $data)
                          <tr>
                           ...
                           <td><img src="{{ asset('img/comp/'.$data->path)}}" alt="{{$data->path}}" title="" width="63" height="63"></td>
                            ...
                            <td>23</td>
                                    <td><a class="btn btn-info btn-xs" href="#" data-toggle="modal" data-target="#modal3"><i class="fa fa-eye mr-1"></i>عرض</a>
                                      <div class="dropdown d-inline-block">
										...
										<a class="dropdown-item delete text-danger" href="{{  url('dalcomp')  }}/{{  $data->comp_id  }}"><i class="fa fa-trash mr-1"></i><span>حذف</span></a></div>
                                      </div>
                                    </td>
                          </tr>
                           @endforeach
              ...
              <div class="row">
                <div class="col-12">
                  <div class="card shadow-none"></div>
                          <div class="d-lg-flex bg-gray-light justify-content-lg-between px-4 py-3">
                            <h4 class="align-self-center">الفرع</h4>
                            <div class="align-self-center">
                  ...
                  <div class="modal fade" id="modal7" tabindex="-1" role="dialog" aria-labelledby="modal7" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                      <div class="modal-content">
                        ...
                        <form  method="post" action="{{ route('files.branch') }}" enctype="multipart/form-data">
						   @csrf

                            <div class="modal-body row">
                              <div class="form-group col-lg-6">
                                <label>اسم الفرع عربي</label>
                                <input name="branch_nameAR" class="form-control" type="text"/>
                              </div>
                              <div class="form-group col-lg-6">
                                <label>اسم الفرع انجليزي</label>
                                <input name="branch_nameEN"class="form-control" type="text"/>
                              </div>
                              <div class="form-group col-lg-6">
                                <label>التلفون</label>
                                <input name="branch_TEL" class="form-control" type="number"/>
                              </div>
							 <div class="form-group col-lg-6">
                                <label> الشركة</label>
                              ...
                              <div class="form-group col-lg-6">
                                <label>فاكس</label>
                                <input name="branch_fax" class="form-control" type="text"/>
                              </div>
                              <div class="form-group col-lg-6">
                                <label>البريد</label>
                                <input name="branch_email" class="form-control" type="text"/>
                              </div>
							  <div class="form-group col-6">
                                <label>صندوق البريد</label>
                                <input name="branch_box" class="form-control" type="text"/>
                              </div>
                              <div class="form-group col-12">
                                <label>العنوان</label>
                                <input name="branch_address" class="form-control" type="text"/>
                              </div>
                              <div class="form-group col-lg-6">
                                <label> الدولة</label>
							...
							<div class="form-group col-lg-6">
                                <label> المحافظ</label>
                                <select class="form-control" name="branch_governor">
							...
							<div class="form-group col-lg-6">
                                <label> الحي</label>
                                <select class="form-control" name="branch_local">
                                    @foreach($sys_neighs as $data)
                                  <option>{{$data->neigh_name}}</option>
                                  @endforeach
                                </select>
                              </div>
							...
							<div class="form-group col-6">
                                ...
                                <input name="branch_webst" class="form-control" type="text"/>
                              </div>
                              <div class="form-group col-12">
                                <label>ملاحظات</label>
                                <textarea  name="notes" class="form-control"></textarea>
                        ...
                        <tr>
                          ...
                          <td>{{$data->branch_address}}</td>
                                  ...
                                  <td><a class="btn btn-info btn-xs" href="#" data-toggle="modal" data-target="#modal9"><i class="fa fa-eye mr-1"></i>عرض</a>
                                    <div class="dropdown d-inline-block">
                                      <button class="btn btn-default btn-xs dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="false"><span>المزيد</span><span class="caret"></span></button>
                                      <div class="dropdown-menu"><a class="dropdown-item text-info" href="#" data-toggle="modal" data-target="#modal9"><i class="fa fa-eye mr-1"></i><span>تفاصيل</span></a><a class="dropdown-item text-warning" href="#" data-toggle="modal" data-target="#modal8"><i class="fa fa-edit mr-1"></i><span>تعديل</span></a>
									  <a class="dropdown-item delete text-danger" href="{{  url('dalbranch')  }}/{{  $data->branch_id  }}"><i class="fa fa-trash mr-1"></i><span>حذف</span></a></div>
                                    </div>
                                  </td>
                        </tr>
                         @endforeach
                ...
                <div class="col-12">
                  <div class="card shadow-none"></div>
                          <div class="d-lg-flex bg-gray-light justify-content-lg-between px-4 py-3">
                            ...
                            <div class="align-self-center">
                              <button class="btn btn-primary departments" data-toggle="modal" data-target="#modal6"><i class="fa fa-plus"></i> اضافة</button>
                              <button class="btn btn-tool" type="button" data-card-widget="maximize"><i class="fas fa-expand"></i></button>
                            </div>
                          </div>
                  <!-- add modal-->
                  <div class="modal fade" id="modal6" tabindex="-1" role="dialog" aria-labelledby="modal6" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <form action="{{ url('deptSort')}}" method="GET" novalidate="">
                          <div class="modal-body">
                            <div class="form-group">
                              <label>اسم القسم عربي</label>
                            ...
                            <div class="form-group">
                              <label> مركز التكلفة</label>
                              <select class="form-control" name="branch_box" >
                                <option>مركز التكلفة 1</option>
                                <option>مركز التكلفة 2</option>
                                <option>مركز التكلفة 3</option>
                                <option>مركز التكلفة 4</option>
                            ...
                            <td>{{$data->Start_date}}</td>
                                  <td><a class="btn btn-info btn-xs" href="#" data-toggle="modal" data-target="#modal9"><i class="fa fa-eye mr-1"></i>عرض</a>
                                    <div class="dropdown d-inline-block">
                                      <button class="btn btn-default btn-xs dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="false"><span>المزيد</span><span class="caret"></span></button>
                                      <div class="dropdown-menu"><a class="dropdown-item text-info" href="#" data-toggle="modal" data-target="#modal9"><i class="fa fa-eye mr-1"></i><span>تفاصيل</span></a><a class="dropdown-item text-warning" href="#" data-toggle="modal" data-target="#modal8"><i class="fa fa-edit mr-1"></i><span>تعديل</span></a>
									  <a class="dropdown-item delete text-danger" href="{{  url('daldept')  }}/{{  $data->dept_id  }}"><i class="fa fa-trash mr-1"></i><span>حذف</span></a></div>
                                    </div>
                                  </td>
                        </tr>
                        @endforeach
