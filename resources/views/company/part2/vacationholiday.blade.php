                    ...
                    <div class="tab-content" id="tabs-tabContent">
                                  ...
                                  <table class="table table-bordered table-striped text-center">
                                    ...
                                    <tbody>
                                      @foreach($sys_holiday as $data)
                                         ...
                                         <td><a class="btn btn-warning btn-xs mx-1" href="#" data-toggle="modal" data-target="#modal2"><i class="fa fa-edit mr-1"></i>تعديل</a>
										 <a class="btn btn-danger btn-xs mx-1" href="{{  url('dalholiday')  }}/{{  $data->holiday_id  }}"><i class="fa fa-trash mr-1"></i>خذف</a>
                                              </td>
                            ...
                            <div class="col-12">
                              ...
                              <div class="card-body">
                                ...
                                <table class="table table-bordered table-striped">
                                  ...
                                  <tbody>
                            @foreach($sys_holidaytype as $data)
                          <tr>
                            <td>{{$data->holidaytype_id}}</td>
                            <td>{{$data->holidaytype_name}}</td>
                            <td>{{$data->numberday}}</td>
                                            <td><a class="btn btn-warning btn-xs mx-1" href="#" data-toggle="modal" data-target="#modal5"><i class="fa fa-edit mr-1"></i>تعديل</a>
											<a class="btn btn-danger btn-xs mx-1" href="{{  url('dalholidaytype')  }}/{{  $data->holidaytype_id  }}"><i class="fa fa-trash mr-1"></i>خذف</a>
                                              </td>
                      ...
                      <div class="modal fade" id="modal70" tabindex="-1" role="dialog" aria-labelledby="modal70" aria-hidden="true">
                       ...
                       <form action="{{ url('offervactionSort')}}" method="GET" novalidate="" >
                              <div class="modal-body row ">
                                ...
                                <div class="form-group ">
                                  ...
                                  <input name="vactionsalary" class="form-control" type="number"/>
                                </div>       </div>
                                ...
                                <div class="form-group ">
                                  <label>له تذاكر  </label>
                                      <select class="custom-select qualifications" name="ticketprice">
                                ...
                                <div class="form-group ">
                                  ...
                                  <input name="contact_number" class="form-control" type="number"/>
                                </div>       </div>
                       ...
                       <form>
                              ...
                              <tbody>
							  @foreach($sys_offervactions as $data)
                                <tr>
                                  <td>{{$data->offervaction_id}}</td>
                                  <td>{{$data->year}}</td>
                                  <td>{{$data->emply_nameAR}}</td>
                                  <td>{{$data->	holidaytype_name}}</td>
                                  <td>{{$data->	start_form}}</td>
                                  <td>{{$data->end_to}}</td>
                                          ...
                                          <td><a class="btn btn-info btn-xs" href="#" data-toggle="modal" data-target="#modal72"><i class="fa fa-eye mr-1"></i>عرض</a>
                                            <div class="dropdown d-inline-block">
                                              ...
                                              <div class="dropdown-menu"><a class="dropdown-item text-info" href="#" data-toggle="modal" data-target="#modal72"><i class="fa fa-eye mr-1"></i><span>تفاصيل</span></a><a class="dropdown-item text-warning" href="#" data-toggle="modal" data-target="#modal71"><i class="fa fa-edit mr-1"></i><span>تعديل</span></a>
											  <a class="dropdown-item delete text-danger" href="{{  url('daloffervactions')  }}/{{  $data->offervaction_id  }}"><i class="fa fa-trash mr-1"></i><span>حذف</span></a></div>
                                            </div>
                                          </td>
                                </tr>
                           @endforeach
                                       ...
                                       <form action="{{ url('vacationbalanceSort')}}" method="GET" novalidate="" >
								           ...
								           <div class="col-lg-4">
									         <div class="form-group">
											   ...
											   <select class="custom-select qualifications" name="dept_name" id="dept_name" value="dept_name">
                                                   <option value="">*اختار الفرع</option>
											   @foreach($users as $data2)
                                                 <option >{{ ucfirst($data2->dept_name) }}</option>
                                                 @endforeach
                                                </select>
                                              </div>
								            </div>
                                         ...
                                         <div class="col-md-6">
                                           ...
                                           <select name="holidaytype_name" class="form-control">
                                            @foreach($sys_holidaytype as $data1)
                                             <option>{{$data1->holidaytype_name }}</option>
                                            @endforeach
                                            </select>
                                           </div>
                                           </div>
                      ...
                      <div class="card-body">
                        ...
                        <table class="table table-bordered table-striped text-center">
                          ...
                          <tbody>
                            <tbody>
                            @foreach($sys_vacationbalance as $data)
                              <tr>
                            <td>{{$data->emply_nameAR}}</td>
							<td>{{$data->year}}</td>
                            <td>{{$data->balanceday}}</td>
                            <td>{{$data->balancehour}}</td>
                            <td>{{$data->holidaytype_name}}</td>

                                                <td><a class="btn btn-info btn-xs" href="#" data-toggle="modal" data-target="#modal62"><i class="fa fa-eye mr-1"></i>عرض</a>
                                  <div class="dropdown d-inline-block">
                                    <button class="btn btn-default btn-xs dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="false"><span>المزيد</span><span class="caret"></span></button>
                                    <div class="dropdown-menu"><a class="dropdown-item text-info" href="#" data-toggle="modal" data-target="#modal62"><i class="fa fa-eye mr-1"></i><span>تفاصيل</span></a><a class="dropdown-item text-warning" href="#" data-toggle="modal" data-target="#modal61"><i class="fa fa-edit mr-1"></i><span>تعديل</span></a>
									<a class="dropdown-item delete text-danger" href="{{  url('dalvacationbalance')  }}/{{  $data->vacationbalance_id   }}"><i class="fa fa-trash mr-1"></i><span>حذف</span></a></div>
                                  </div>
                                </td>
                                     </tr>
                                 @endforeach
                    ...
                    <div class="card border">
                      ...
                      <div class="card-body">
                        ...
                        <table class="table table-bordered table-striped text-center">
                          ...
                          <tbody>
                            <tr>
                             @foreach($sys_years as $data)


							 <td>{{$data->year_id}}</td>
                             <td>{{$data->years_gregorian}}</td>
                             <td>{{$data->years_hijri}}</td>
                             <td>{{$data->years_status}}</td>
                             <td>{{$data->start_form}}</td>
                             <td>{{$data->end_to}}</td>
                             <td>{{$data->working_daysG}}</td>
                             <td>{{$data->working_daysH}}</td>
                                  <td><a class="btn btn-warning btn-xs mx-1" href="#" data-toggle="modal" data-target="#modal78"><i class="fa fa-edit mr-1"></i>تعديل</a>
								  <a class="btn btn-danger btn-xs mx-1" href="{{  url('dalyear')  }}/{{  $data->year_id  }}"><i class="fa fa-trash mr-1"></i>خذف</a>
                                              </td>
