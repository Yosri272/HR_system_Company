              ...
              <div class="row mb-2">
                <div class="col-sm-12 mb-3">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><span>اللغات</span></li>
                  </ol>
                </div>
                <div class="col-sm-12">
                  <h1>اللغات</h1>
        ...
        <div class="card border">
          <div class="card-header p-2">
                    <div class="d-lg-flex bg-gray-light justify-content-lg-between px-4 py-3">
                      <h4 class="align-self-center">قائمة اللغات</h4>
          ...
          <div class="modal fade" id="modal7" tabindex="-1" role="dialog" aria-labelledby="modal7" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <form action="{{ url('languageSort')}}" method="GET" novalidate="">
                  <div class="modal-body">
                    <div class="form-group">
                      <label>اسم اللغة</label>
                      <input   name="languages_name" class="form-control" type="text"/>
                    </div>
                  </div>
          ...
          <div class="card-body">
            ...
            <table class="table table-bordered table-striped">
              ...
              <tbody>
                @foreach($sys_languages as $data)
                <tr>
                  <td>{{$data->languages_id}}</td>
                  <td>{{$data->languages_name}}</td>
                    <td><a class="btn btn-warning btn-xs mx-1" href="#" data-toggle="modal" data-target="#modal8"><i class="fa fa-edit mr-1"></i>تعديل</a>
					<a class="btn btn-danger btn-xs mx-1" href="{{  url('dallanguages')  }}/{{  $data->languages_id  }}"><i class="fa fa-trash mr-1"></i>خذف</a>
                          </td>
                </tr>
                @endforeach
              </tbody>
