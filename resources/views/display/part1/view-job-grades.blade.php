              ...
              <div class="row mb-2">
                <div class="col-sm-12">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                      <a href="{{ url('job-grades') }}">
                        المسميات الوظيفية
                      </a>
                    </li>
                    <li class="breadcrumb-item">
                      <span>تفاصيل الدرجات الوظيفية</span>
                    </li>
                  </ol>
                </div><!-- /.col -->
                <div class="col-sm-12">
                        ...
                        <div class="col-lg-6">
                          <table class="table table-striped">
                            <tbody>
                              ...
                              <tr>
                                <td style="width: 20%;"> رقم الدرجة </td>
                              ...
                              <tr>
                                <td> فئه الوظيفية </td>
                                <td>  {{$data->jop_category}}
                                  <a class="btn btn-info btn-xs" href="{{ url('view-categories') }} "><i class="fa fa-eye"></i>
                                    عرض</a>
                                </td>
                              </tr>
                        ...
                        <div class="col-lg-6">
                          <table class="table table-striped">
                            <tbody>
                                @foreach($a_viewData as $data)
                              <tr>
                                <td> العلاوة السنوية </td>
                                <td> {{$data->year}} </td>
                              </tr>

                              <tr>
                                <td> اعلا مرتب للدرجة </td>
                                <td> {{$data->year}}</td>
                              </tr>

                              <tr>
                                <td> ادني مرتب للدرجة </td>
                        ...
                        <div class="col-lg-12">
                          <table class="table table-striped">
                            <tbody>
                              ...
                              <tr>
                                <td> ملاحظات </td>
                                <td> هذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة، لقد تم توليد </td>
                              </tr>
