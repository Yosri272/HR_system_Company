              ...
              <div class="row mb-2">
                <div class="col-sm-12">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                      <span> بيانات اثباتات الموظف</span>
                    </li>
                  </ol>
                </div><!-- /.col -->
                <div class="col-sm-12">
                  <h1> بيانات اثباتات الموظف </h1>
                </div><!-- /.col -->
              </div><!-- /.row -->
            </div><!-- /.container-fluid -->
          </div>
                ...
                <ul class="nav nav-tabs" id="tabs-tab" role="tablist">
                    <li class="nav-item ">
                      ...
                      <a class="nav-link " id="tabs-file-tab" data-toggle="pill" href="#tabs-file" role="tab"
                        aria-controls="tabs-file" aria-selected="false">المرفقات    </a>
                    </li>
                  <li class="nav-item">
                    ...
                    <div class="row">
                            <div class="col-6">
                              <div class="card  shadow-none">
                                 <h4 class="text-center"  > اسم الاثبات :  اقامة</h4>
                                <!-- /.card-header -->
                                <div class="card-body">
            ...
            <div class="card card-widget">
              <div class="card-header">
                <div class=" text-left">
                    <div class="a">
                        <strong>
                  <span class="username">جواز سفر</span>
                            </strong>
                        </div>
