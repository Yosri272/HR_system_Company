          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              ...
              <a href="{{ url('transfers') }}" class="nav-link">
                ...
                <p> التنقلات</p>
                 ...
                 <li class="nav-item"><a class="nav-link" href="#"><i class="fas fa-cogs nav-icon"></i>
              <p> الاعدادات <i class="right fas fa-angle-left"></i></p></a>
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item"><a class="nav-link" href="{{ url('locations') }}"><i class="far fa-circle nav-icon"></i>
                  ...
                  <p>اللغات</p></a></li>
                  <li class="nav-item"><a class="nav-link" href="{{ url('nationality') }}"><i class="far fa-circle nav-icon"></i>
                    <p>الجنسبة</p></a></li>
                <li class="nav-item"><a class="nav-link" href="{{ url('sys') }}"><i class="far fa-circle nav-icon"></i>
                  <p>الحسابات</p></a></li>
                <li class="nav-item"><a class="nav-link" href="{{ url('employeesettings') }}"><i class="far fa-circle nav-icon"></i>
                  <p>اعدادات الموظف</p></a>
                </li>



                   <li class="nav-item"><a class="nav-link" href="{{ url('contracts') }}"
